  ...
  constructor(props) {
    ...
    this.workDetails = [
      ...
      },
      {
        ...
        projectDesc: 'Flamegraphs are a data driven method to profile performance of Python/Pyspark jobs and improve code runtime.',
        projectType: 'Python',
      ...
      },
      {
        ...
        projectDesc: 'Map of OpenStreetMap changesets my team reviewed in a year and incorrect edits found.',
        projectType: 'WEB APP',
